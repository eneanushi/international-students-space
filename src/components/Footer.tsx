              ...
              <li className="flex gap-4 mt-4">
                {[
                  ...
                  <a 
                    key={social.icon}
                    href={social.href} 
                    className="text-white/60 hover:text-[#607afb] transition-colors p-2 rounded-full hover:bg-white/5"
                  >
            ...
            <div className="flex gap-6">
              {['Privacy Policy', 'Terms of Service', 'Cookie Policy'].map((item) => (
                <a 
                  key={item}
                  href="#" 
                  className="text-white/60 hover:text-[#607afb] transition-colors text-sm"
                >
                  {item}
                </a>
              ))}
